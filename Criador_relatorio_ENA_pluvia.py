...
if envia_email:
    ...
    assunto = 'RELATÓRIO DE PREVISÃO DIÁRIA DE ENA - ' + hoje
    ...
    destinatario = ['todosenevacom@eneva.com.br','marco.vieira@eneva.com.br','marcelo.caixeta@eneva.com.br'] #todosenevacom

    #envia_email_pdf_gif (assunto, corpo, caminho_pdf, caminho_gif, destinatario)
    envia_email_python(assunto, corpo, caminho_pdf, arquivo_pdf, destinatario)
