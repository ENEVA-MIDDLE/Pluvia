...
from Funcoes_API_prospec import download_estudos_finalizados_diario3
...
##NEW#pasta prevs individual por modelo
  ...
  ############################################################################################################################# 
    caminho_arquivo_criacao_estudo = r'J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\05. Diario\Criacao_Estudos_diario_prevsENEVA.xlsm'
  ...
  ######Cria rodada ######################################################################################################################## 
    ...
    while True:
        ...
        resposta = download_estudos_finalizados_diario3(pasta_relatorio)#baixa estudos, salva na rede, descompacta, joga na base prospec
