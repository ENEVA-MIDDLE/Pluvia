...
def copia_semanal ():
  excel_caminho = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Calculo_Mensal_VariosEstudos_Semanal.xlsx"
...
def apagar_linhas_semanal(): 
 excel_caminho = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Calculo_Mensal_VariosEstudos_Semanal.xlsx"
 caminho =  r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\12.ANALISES\Prospec\Base_prospec_diario_v1.xlsx" 
 #caminho_prospec = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\12.ANALISES\Prospec\Base_prospec_diario.xlsx"
 ...
 #wb_pr = xl.load_workbook(caminho_prospec)
 
 #ws_pr = wb['formulario'] 
 #ws_pr['D'].delete_rows(7, ws_pr.max_row+1)
 #ws_pr['E'].delete_rows(7, ws_pr.max_row+1) 
...
def funcao_copia_cola_semanal(StudyId): 
...
#Chama a funcao que apaga as linhas
 ...
 caminho_estudo = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Calculo_Mensal_VariosEstudos_Semanal.xlsx"
...
#print(ws2_pld_sudeste.cell(row = 11, column = 1).value)
 ...
 for i in range (11, mr+1): 
      ...
      if ws2_cadastro.cell(row = 3, column = 2).value == 5:   
                  c = ws3.cell(row = aux_ws3, column = 8).value
                  c_1 = ws3.cell(row = aux_ws3 - 1, column = 8).value
                  c_2 = ws3.cell(row = aux_ws3 - 2, column = 8).value
                  c_3 = ws3.cell(row = aux_ws3 - 3, column = 8).value
                  c_4 = ws3.cell(row = aux_ws3 - 4, column = 8).value
                  ws2_pld_sudeste.cell(row = i, column = 6).value = c_4 
                  ws2_pld_sudeste.cell(row = i, column = 7).value = c_3
                  ws2_pld_sudeste.cell(row = i, column = 8).value = c_2
                  ws2_pld_sudeste.cell(row = i, column = 9).value = c_1
                  ws2_pld_sudeste.cell(row = i, column = 10).value = c
...
#ax_ws3 = len(ws3(column = 12))
 ...
 for i in range (11, mr+1): 
      ...
      if ws2_cadastro.cell(row = 3, column = 2).value == 5:           
                  ...
                  c_2 = ws3.cell(row = aux_ws3 - 2, column = 9).value
                  c_3 = ws3.cell(row = aux_ws3 - 3, column = 9).value
                  c_4 = ws3.cell(row = aux_ws3 - 4, column = 9).value
                  ws2_pld_sul.cell(row = i, column = 6).value = c_4
                  ws2_pld_sul.cell(row = i, column = 7).value = c_3
                  ws2_pld_sul.cell(row = i, column = 8).value = c_2
                  ws2_pld_sul.cell(row = i, column = 9).value = c_1
                  ws2_pld_sul.cell(row = i, column = 10).value = c
...
############# Para o Norte
 ...
 for i in range (11, mr+1): 
      ...
      if ws2_cadastro.cell(row = 3, column = 2).value == 4:            
                  ...
                  c_2 = ws3.cell(row = aux_ws3 - 2, column = 11).value
                  c_3 = ws3.cell(row = aux_ws3 - 3, column = 11).value
                  c_4 = ws3.cell(row = aux_ws3 - 4, column = 11).value  
                  ws2_pld_norte.cell(row = i, column = 6).value = c_4 
                  ws2_pld_norte.cell(row = i, column = 7).value = c_3
                  ws2_pld_norte.cell(row = i, column = 8).value = c_2
                  ws2_pld_norte.cell(row = i, column = 9).value = c_1
                  ws2_pld_norte.cell(row = i, column = 10).value = c
...
############ Para o Nordeste
 ...
 for i in range (11, mr+1): 
      ...
      if ws2_cadastro.cell(row = 3, column = 2).value == 5:                  
                  ...
                  c_2 = ws3.cell(row = aux_ws3 - 2, column = 10).value
                  c_3 = ws3.cell(row = aux_ws3 - 3, column = 10).value
                  c_4 = ws3.cell(row = aux_ws3 - 4, column = 10).value
                  ws2_pld_ne.cell(row = i, column = 6).value = c_4
                  ws2_pld_ne.cell(row = i, column = 7).value = c_3
                  ws2_pld_ne.cell(row = i, column = 8).value = c_2
                  ws2_pld_ne.cell(row = i, column = 9).value = c_1
                  ws2_pld_ne.cell(row = i, column = 10).value = c           
...
# Opening and saving XLSX file, so results for each stored formula can be evaluated and cashed so OpenPyXL can read them.
 excel_file = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Calculo_Mensal_VariosEstudos_Semanal.xlsx"
...
def StudyId_semanal (StudyId):
 filename = r'J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Criacao_Estudos.xlsm'
 caminho_estudo = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Calculo_Mensal_VariosEstudos_Semanal.xlsx"
 arquivo_excel_rodada = xl.load_workbook(caminho_estudo, read_only = False)
...
def ena_realizada_semanal (): 
 ...
 def atualizar_dados_semanal(data):
...
#ultima_data_rdh = time.ctime(data_rdh[0]) 
 ...
 caminho = r"J:\SEDE\Comercializadora de Energia\6. MIDDLE\13.RODADAS\06.Semanal\Calculo_Mensal_VariosEstudos_Semanal.xlsx"
